...
- `.moai/docs/pilot-incident-runbook.md` — 파일럿 운영 중 장애 대응 절차(triage 담당자·로그 이벤트 표·§4 원격 DB 단독 진행 원칙의 출처; 5차 개정에서 §1 이벤트 표·§2 TTL 서술을 실제 async 경로에 맞춰 이 SPEC이 직접 편집하는 대상으로 전환)
