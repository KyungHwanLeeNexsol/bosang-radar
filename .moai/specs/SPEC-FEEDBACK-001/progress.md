...
- third_round_plan_audit_rerun: _<pending — orchestrator will run a final plan-auditor pass after this amendment; verdict to be recorded here once available>_
